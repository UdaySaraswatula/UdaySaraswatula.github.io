...
define(['exports', 'ojs/ojdvt-toolkit', 'ojs/ojdvt-panzoomcanvas', 'ojs/ojkeyboardfocus-utils', 'ojs/ojdvt-overview', 'ojs/ojcustomelement-registry'], function (exports, dvt, ojdvtPanzoomcanvas, ojkeyboardfocusUtils, ojdvtOverview, ojcustomelementRegistry) { 'use strict';
   ...
   */
  class DvtDiagramDefaults extends dvt.BaseComponentDefaults {
    constructor(context) {
   ...
   * @constructor
   */
  class DvtDiagramCategoryRolloverHandler extends dvt.CategoryRolloverHandler {
   ...
   */
  class DvtDiagramLink extends dvt.Container {
    ...
    animateUpdate(animationHandler, oldLink, bCleanUp) {
      ...
      if (this._getCustomRenderer('renderer')) {
        ...
        if (animateFrom && animateTo) {
          var oldPointsCustom = dvt.ToolkitUtils.getAttrNullNS(animateFrom, 'd');
          var newPointsCustom = dvt.ToolkitUtils.getAttrNullNS(animateTo, 'd');

          dvt.ToolkitUtils.setAttrNullNS(animateTo, 'd', oldPointsCustom);
    ...
    animateDelete(animationHandler) {
      ...
      var playable = new dvt.AnimFadeOut(this.getCtx(), this, animationHandler.getAnimDur());
   ...
   */
  class DvtDiagramNode extends dvt.Container {
    ...
    static _addHoverSelectionOuterStrokes(selectionShape, nodeData) {
      ...
      if (isRedwood) {
        his = new dvt.Stroke(hoverInnerColor, 1, 1, true);
        hos = new dvt.Stroke(hoverOuterColor, 1, 3, true);
        sis = new dvt.Stroke(hoverInnerColor, 1, 1, true);
        sos = new dvt.Stroke(selectionColor, 1, 3, true);
        selectionShape.setHoverStroke(his, hos).setSelectedStroke(sis, sos);
      } else {
        ...
        his = new dvt.Stroke(hoverInnerColor, 1, 2, true);
        hos = new dvt.Stroke(hoverOuterColor, 1, 2, true);
        sis = new dvt.Stroke(hoverInnerColor, 1, 1, true);
   ...
   * @constructor
   */
  class DvtDiagramEventManager extends dvt.EventManager {
    ...
    ClearDropEffect() {
      ...
      if (obj && obj.__dropPort) {
        dvt.ToolkitUtils.removeClassName(obj.__dropPort, this.OJ_ACTIVE_DROP);
        dvt.ToolkitUtils.removeClassName(obj.__dropPort, this.OJ_INVALID_DROP);
      }
   ...
   */
  class DvtDiagramKeyboardHandler extends ojdvtPanzoomcanvas.PanZoomCanvasKeyboardHandler {
   ...
   * @extends {Overview}
   */
  class DvtDiagramOverview extends ojdvtOverview.Overview {
    constructor(diagram) {
    ...
    CloneAnim() {
      var context = this.getCtx();
      var overviewClone = new dvt.Container(context, 'g', this.getId());
      overviewClone.ContentBounds = this._callbackObj.GetViewBounds();
      overviewClone.setMouseEnabled(false);
      var ovContentClone = new dvt.Container(context, 'g', 'ovContentClone');
   ...
   * @constructor
   */
  class DvtDiagramDataAnimationHandler extends dvt.DataAnimationHandler {
   ...
   * @constructor
   */
  class Diagram extends ojdvtPanzoomcanvas.PanZoomComponent {
    constructor(context, callback, callbackObj) {
