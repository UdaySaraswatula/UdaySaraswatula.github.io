                ...
                _fetchNext() {
                    ...
                    return new Promise((resolve, reject) => {
                        ...
                        resolve(this._baseIterator.next().then((result) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield this._parent._mergeEdits(baseItemArray, this.mergedItemArray, this._params.filterCriterion, this._parent.lastSortCriteria, this.mergedAddKeySet, result.done);
