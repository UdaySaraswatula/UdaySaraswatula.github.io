...
define(['exports', 'ojs/ojcore-base', 'ojs/ojdatagridprovider', 'ojs/ojeventtarget', 'ojs/ojdatacollection-common'], function (exports, oj, ojdatagridprovider, ojeventtarget, DataCollectionUtils) { 'use strict';
    ...
    class RowDataGridProvider {
        ...
        _handleUnderlyingMutation(event) {
            ...
            if (needsRefresh) {
                this.resetInternal();
                this.dispatchEvent(new ojdatagridprovider.DataGridProviderRefreshEvent());
            }
            else {
                if (removeEventDetail) {
                    this.dispatchEvent(new ojdatagridprovider.DataGridProviderRemoveEvent(removeEventDetail));
                }
                if (addEventDetail) {
                    this.dispatchEvent(new ojdatagridprovider.DataGridProviderAddEvent(addEventDetail));
                }
    ...
    ojeventtarget.EventTargetMixin.applyMixin(RowDataGridProvider);

    exports.RowDataGridProvider = RowDataGridProvider;
