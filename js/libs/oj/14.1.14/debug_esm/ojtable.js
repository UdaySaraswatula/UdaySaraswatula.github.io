    ...
    provide: [
      {
        ...
        default: new Map([[FormVariantContext, 'embedded']])
      }
    ]
  };
...
Table.prototype._refreshTableBody = function (resultObject, startIndex, keepVisible) {
  ...
  this._refreshAddNewRowPlaceholder(true);
