...
BaseCustomElementBridge.proto = {
  ...
  initializeBridge: function (element, descriptor) {
    ...
    this.State = CustomElementUtils.getElementState(element);
  },
  ...
  AttributeChangedCallback: function (attr, oldValue, newValue) {
    ...
    const prop = AttributeUtils.attributeToPropertyName(attr);
  ...
  GetEventListenerProperty: function (property) {
    var event = AttributeUtils.eventListenerPropertyToEventType(property);
    // Get event listener
