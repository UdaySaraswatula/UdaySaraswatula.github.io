...
class FlattenedTreeDataProviderView {
    constructor(dataProvider, options) {
        ...
        this._expandedObservable = new BehaviorSubject(this._getExpandedObservableValue(this.options.expanded, Promise.resolve()));
        ...
        this._mapParentKeyToInfo.set(null, { done: false });
        this._done = false;
    }
            ...
            addEvent.parentKeys.forEach((parentKey, index) => {
                if ((parentKey === null || (this._isExpanded(parentKey) && this._getItemByKey(parentKey))) &&
                    ...
                    if (newIndex != null) {
                        ...
                        const indexFromParent = (addEvent === null || addEvent === void 0 ? void 0 : addEvent.indexes) ? addEvent.indexes[index] : null;
                        const item = this._updateItemMetadata(new this.Item(this, addEvent.metadata[index], addEvent.data[index]), parentKey, indexFromParent);
                        this._cache.splice(newIndex, 0, item);
                        this._incrementIndexFromParent(newIndex, item.metadata.treeDepth);
